...
import styles from './VerticalCard4.module.scss';
...
/**
 * Used on persoonlijk home page.
 * @param props
 */
function VerticalCard4(props: Props) {
    return (
        <article
            style={props.style}
...
function getCssClassNames(): string[] {
    return [styles.verticalCard4];
}

export { VerticalCard4, getCssClassNames };
