...
function Page() {
    ...
    return (
        <>
            <Head>
                <title>
                    Hybrid Card 1 - Design System - Het Financieele Dagblad
                </title>
                <meta
                    name="description"
                    content="Hybrid Card 1, on small screens its similar to Horizontal Card 1 and wider screens similar to Vertical Card 1"
                />
            </Head>
